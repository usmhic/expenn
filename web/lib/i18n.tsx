...
const dict: Record<Lang, Dict> = {
  en: {
    nav: { how: "How it works", features: "Features", pricing: "Pricing", contact: "Contact", start: "Start free" },
    common: {
      backHome: "Back home",
      goHome: "Go home",
      tryAgain: "Try again",
    ...
    pricing: {
      ...
      title2: "pricing.",
      free: "Free",
      freeSub: "Perfect for solo travelers.",
      forever: "forever",
      freeFeats: ["1 traveler", "Unlimited trips", "Receipt capture", "Expense tracking", "Document storage", "CSV exports"],
      team: "Team",
      teamSub: "Add teammates when you need them.",
      perTraveler: "/mo per traveler",
      teamBadge: "For teams",
      teamFeats: ["Shared trips", "Team approvals", "Budget tracking", "Multi-user collaboration", "Shared expense visibility"],
      ctaFree: "Start free",
      ctaTeam: "Get early access",
    },
    final: {
    ...
    terms: {
      ...
      sections: [
        ...
        { h: "4. Subscriptions and billing", p: "Paid plans are billed monthly per active traveler. You can cancel at any time and your plan will end at the close of the current billing cycle." },
        { h: "5. Your content", p: "You own everything you upload. You grant us only the permissions needed to operate the service on your behalf (storage, processing, backup)." },
        { h: "6. Liability", p: 'Expenn is provided "as is". To the extent allowed by law our liability is limited to the amount you paid for the service in the previous 12 months.' },
        { h: "7. Contact", p: "Questions about these terms? Email hi@expenn.com." },
      ],
    },
  },
  es: {
    nav: { how: "Cómo funciona", features: "Funciones", pricing: "Precios", contact: "Contacto", start: "Empieza gratis" },
    common: {
    ...
    pricing: {
      ...
      title2: "simples.",
      free: "Gratis",
      freeSub: "Perfecto para viajeros en solitario.",
      forever: "para siempre",
      freeFeats: ["1 viajero", "Viajes ilimitados", "Captura de recibos", "Control de gastos", "Almacén de documentos", "Exportar a CSV"],
      team: "Equipo",
      teamSub: "Añade compañeros cuando lo necesites.",
      perTraveler: "/mes por viajero",
      teamBadge: "Para equipos",
      teamFeats: ["Viajes compartidos", "Aprobaciones de equipo", "Control de presupuesto", "Colaboración multiusuario", "Visibilidad compartida"],
      ctaFree: "Empieza gratis",
      ctaTeam: "Acceso anticipado",
    },
    final: {
    ...
    terms: {
      ...
      sections: [
        ...
        { h: "4. Suscripciones y facturación", p: "Los planes de pago se facturan mensualmente por viajero activo. Puedes cancelar cuando quieras y tu plan termina al final del ciclo en curso." },
        { h: "5. Tu contenido", p: "Eres dueño de todo lo que subes. Nos das solo los permisos necesarios para operar el servicio en tu nombre (almacenamiento, procesamiento, copias)." },
        { h: "6. Responsabilidad", p: 'Expenn se ofrece "tal cual". En la medida que la ley lo permita, nuestra responsabilidad se limita al importe pagado por el servicio en los 12 meses previos.' },
        { h: "7. Contacto", p: "¿Dudas sobre los términos? Escribe a hi@expenn.com." },
      ],
    },
  },
};
